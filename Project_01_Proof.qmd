...
```{r, echo=TRUE, output=FALSE}
# This function automates the step above, taking the results of two or more URLs and producing a list of combined Tibbles seperated by County and NonCounty. 
