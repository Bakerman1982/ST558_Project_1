...
plot.county <- function(data, state = "TX", var_name = "Enrollment_Value", top_or_bottom = "top", n = 5) {
...
plot.county(Frames_Joined_On_Geo[[1]], state = "FL", var_name = "Enrollment_Value", top_or_bottom = "bottom", n = 5)
```
